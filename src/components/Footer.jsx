...
const Footer = () => {
  ...
  return (
    <footer className=" p-4 w-full space-x-5 bg-gradient-to-t from-yellow-700 to-yellow-400 sticky pb-0">
        ...
        <div>
        <p className="text-black text-center w-[100%] pt-5 text-xs">Copyright ⓒ {currentYear} All rights reserved-Faculty of science,UoP</p>
        </div>
    </footer>
  )
}
